...
function convertJsonToOlx(jsonPath) {
  ...
  const olxContent = `<!--
---
description: Question bank for operant conditioning mastery assessment in psychology course. Not an independent activity -- included to allow direct access to the content. Note that this file is automatically generated, so edits will be overwritten when the system is rebuilt.
category: psychology
lang: en-Latn-US
generated:
  method: build
