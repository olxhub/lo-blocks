...
const Changer = ({ children }) => (
  <SideBarPanel>
    ...
    <div>
      ...
      <br/>
      <LLMButton>
        <LLMPrompt target="essay_rewrite">You're a Chinese American. Please rewrite this. Use English, but with Chinese communication style: <Element>student_essay</Element></LLMPrompt>
        Chinese American
      </LLMButton>
      <br/>
      <LLMButton>
