...
function peg$parse(input, options) {
  ...
  let peg$startRuleFunction = peg$parseClip;
  ...
  const peg$e1 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_", ".", " ", ":", "-"], false, false, false);
  ...
  function peg$f0(open, start, end, close) {
    return {
      open,
      close,
      start: start ?? null,
  ...
  function peg$parseClip() {
    ...
    s0 = peg$parseRangeClip();
    if (s0 === peg$FAILED) {
      s0 = peg$parseSingleClip();
    }

    return s0;
  }

  function peg$parseRangeClip() {
    ...
    if (s2 !== peg$FAILED) {
      ...
      if (s6 !== peg$FAILED) {
        ...
        s9 = peg$parse_();
        s10 = peg$parseCloseBracket();
        if (s10 !== peg$FAILED) {
          s11 = peg$parse_();
          peg$savedPos = s0;
          s0 = peg$f0(s2, s4, s8, s10);
        } else {
          peg$currPos = s0;
          s0 = peg$FAILED;
        }
  ...
  function peg$parseQuotedString() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parseNotDoubleQuotedChar();
      while (s3 !== peg$FAILED) {
        s2.push(s3);
        s3 = peg$parseNotDoubleQuotedChar();
      }
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$parseNotSingleQuotedChar();
        while (s3 !== peg$FAILED) {
          s2.push(s3);
          s3 = peg$parseNotSingleQuotedChar();
        }
  ...
  function peg$parseNotDoubleQuotedChar() {
    let s0;
  ...
  function peg$parseNotSingleQuotedChar() {
    let s0;
