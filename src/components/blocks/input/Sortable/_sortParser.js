...
function peg$parse(input, options) {
  ...
  function peg$f3(index, content) {
    return createItem(index, content);
  }
  function peg$f4(digits) {    return parseInt(digits.join(''), 10);  }
  ...
  function peg$parsenumbered_line() {
    let s0, s1, s2, s3, s4;
