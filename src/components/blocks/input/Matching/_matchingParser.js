...
function peg$parse(input, options) {
  ...
  function peg$f0(title, pairs) {
    return {
      title: title.trim(),
      pairs: pairs.filter(p => p !== null)
    };
  }
  function peg$f1(pairs) {
    return {
      title: '',
      pairs: pairs.filter(p => p !== null)
    };
  ...
  function peg$parsepair_line() {
    let s0, s1, s2, s3, s4;

    s0 = peg$currPos;
    s1 = peg$parsepair_content();
  ...
  function peg$parsepair_content() {
