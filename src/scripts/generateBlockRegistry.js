...
const registryTypes = {
  blocks: {
    ...
    outputFile: path.resolve(process.cwd(), 'src/components/blockRegistryAutogen.ts'),
    metadataFile: path.resolve(process.cwd(), 'src/components/blockMetadataAutogen.json'),
