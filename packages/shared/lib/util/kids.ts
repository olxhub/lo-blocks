...
import type { JSONValue, BlueprintKidEntry } from '@/lib/types';
...
/** Assert that kids is a BlueprintKidEntry[]. Throws if not an array. */
export function assertKidArray(value: JSONValue): asserts value is BlueprintKidEntry[] {
...
export function isKidArray(value: JSONValue): value is BlueprintKidEntry[] {
