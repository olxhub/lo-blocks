...
function peg$parse(input, options) {
  ...
  const peg$e11 = peg$literalExpectation("_{", false);
  ...
  function peg$f15(base, content) {    return "_{" + content + "}";  }
  function peg$f16(base, lower, upper, primes) {
    return base + (lower || '') + "^{" + upper + "}" + primes;
  }
  function peg$f17(base, lower, primes) {
    return base + "_{" + lower + "}" + primes;
  }
  function peg$f18(name, primes) {
    return name + primes;
  }
  function peg$f19(value, suffix) {
    return {
      type: 'number',
      value: value + (suffix || ''),
      suffix: suffix || null
  ...
  function peg$f20(mantissa, exponent) {
  ...
  function peg$parseSignedProduct() {
    let s0, s1, s2, s3;
  ...
  function peg$parsePlainVariable() {
