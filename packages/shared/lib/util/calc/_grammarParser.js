...
function peg$parse(input, options) {
  ...
  const peg$e7 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false, false);
  const peg$e8 = peg$literalExpectation("_{", false);
  ...
  function peg$f6(head, right) {    return right;  }
  function peg$f7(head, tail) {
    if (tail.length === 0) return head;
    return { type: 'parallel', operands: [head, ...tail] };
  }
  function peg$f8(base, sign, exp) {
    let exponent = exp;
  ...
  function peg$f14(base, content) {    return "_{" + content + "}";  }
  function peg$f15(base, lower, upper, primes) {
    return base + (lower || '') + "^{" + upper + "}" + primes;
  }
  function peg$f16(base, lower, primes) {
    return base + "_{" + lower + "}" + primes;
  }
  function peg$f17(name, primes) {
    return name + primes;
  }
  function peg$f18(value, suffix) {
    return {
      type: 'number',
      value: value + (suffix || ''),
      suffix: suffix || null
  ...
  function peg$f19(mantissa, exponent) {
