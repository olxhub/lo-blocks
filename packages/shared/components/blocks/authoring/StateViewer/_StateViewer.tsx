...
import { scopedStateKeyForBlock, stateKeyForGlobalRef, parseAnyStateRef , PLACEHOLDER_NS } from '@/lib/types/id-grammar';
...
export default function _StateViewer(props: RuntimeProps) {
  ...
  const targetStateKey = targetRef ? stateKeyForGlobalRef(targetRef, props.runtime?.ns ?? PLACEHOLDER_NS) : scopedStateKeyForBlock(props);
