...
import { extendIdPrefix, scopeMarker, parseDefinitionRef, scopedStateKeyForBlock, stateKeyForGlobalRef , PLACEHOLDER_NS } from '@/lib/types/id-grammar';
...
function MasteryProblem({ props, problemId, attemptNumber, masteryState, handlers }) {
  ...
  const { block: renderedProblem, error } = useBlock(scopedProps, stateKeyForGlobalRef(problemId, props.runtime?.ns ?? PLACEHOLDER_NS));
