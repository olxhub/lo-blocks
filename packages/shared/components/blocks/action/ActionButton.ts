...
import { z_reduxStateRefList } from '@/lib/blocks/attributeSchemas';
...
const ActionButton = blocks.dev({
  ...
  attributes: z.object({
    ...
    target: z_reduxStateRefList.optional().describe('Action block ID(s) to trigger, comma-separated (inferred from context if omitted)'),
