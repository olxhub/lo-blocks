...
import { problemAttributes, z_reduxStateRefList, z_reduxStateRef } from '@/lib/blocks/attributeSchemas';
...
const CapaFooter = blocks.dev({
  ...
  attributes: z.object({
    ...
    target: z_reduxStateRefList.optional().describe('Comma-separated grader IDs to trigger'),
    hintsTarget: z_reduxStateRef.nullish().describe('DemandHints ID for hint button'),
